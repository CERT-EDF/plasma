"""Plasma Linux Memory Dissectors
    ...
    linux.check_afinfo.Check_afinfo                     Verifies the operation function pointers of network protocols (deprecated).
    linux.check_creds.Check_creds                       Checks if any processes are sharing credential structures (deprecated).
    linux.check_idt.Check_idt                           Checks if the IDT has been altered (deprecated).
    linux.check_modules.Check_modules                   Compares module list to sysfs info, if available (deprecated).
    linux.check_syscall.Check_syscall                   Check system call table for hooks (deprecated).
    ...
    linux.hidden_modules.Hidden_modules                 Carves memory to find hidden kernel modules (deprecated).
    ...
    linux.keyboard_notifiers.Keyboard_notifiers         Parses the keyboard notifier call chain (deprecated).
    ...
    linux.malfind.Malfind                               Lists process memory ranges that potentially contain injected code (deprecated).
    ...
    linux.modxview.Modxview                             Centralize lsmod, check_modules and hidden_modules results to efficiently spot modules presence and taints (deprecated).
    linux.mountinfo.MountInfo                           Lists mount points on processes mount namespaces
    linux.netfilter.Netfilter                           Lists Netfilter hooks (deprecated).
    ...
    linux.tty_check.tty_check                           Checks tty devices for hooks (deprecated).
