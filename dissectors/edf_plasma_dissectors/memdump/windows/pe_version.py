"""Windows PE Versions Memory Dissector"""
...
_VOL_PLUGIN = 'windows.verinfo.VerInfo'
_VOL_FIELDS_MAPPING = {
    'PID': 'pid',
    'Process': 'process',
    'Base': 'base',
...
DISSECTOR = Dissector(
    slug='memdump_windows_pe_version',
    ...
    columns=[
        ...
        Column('major', DataType.STR),
        Column('minor', DataType.STR),
        Column('product', DataType.STR),
        Column('build', DataType.STR),
    ],
    description="Windows PE versions from memory dump",
