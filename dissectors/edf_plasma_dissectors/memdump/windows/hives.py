"""Windows Hives Memory Dissector"""
...
_VOL_PLUGIN = 'windows.registry.hivelist.HiveList'
_VOL_FIELDS_MAPPING = {'FileFullPath': 'filefullpath', 'Offset': 'offset'}
...
DISSECTOR = Dissector(
    slug='memdump_windows_hives',
    tags={Tag.MEMDUMP, Tag.WINDOWS},
    columns=[
        Column('filefullpath', DataType.STR),
        Column('offset', DataType.INT),
    ],
    description="Windows hives from memory dump",
