"""Windows Command Line Memory Dissector"""
...
_VOL_PLUGIN = 'windows.cmdline.CmdLine'
_VOL_FIELDS_MAPPING = {'PID': 'pid', 'Process': 'process', 'Args': 'args'}
...
DISSECTOR = Dissector(
    slug='memdump_windows_cmdline',
    tags={Tag.MEMDUMP, Tag.WINDOWS},
    columns=[
        Column('pid', DataType.INT),
        Column('process', DataType.STR),
        Column('args', DataType.STR),
    ],
    description="Windows command line from memory dump",
