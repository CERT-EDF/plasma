"""Windows Environment Variables Memory Dissector"""
...
_VOL_PLUGIN = 'windows.envars.Envars'
_VOL_FIELDS_MAPPING = {
    'PID': 'pid',
    'Process': 'process',
    'Variable': 'variable',
...
DISSECTOR = Dissector(
    slug='memdump_windows_envars',
    tags={Tag.MEMDUMP, Tag.WINDOWS},
    columns=[
        Column('pid', DataType.INT),
        Column('process', DataType.STR),
        Column('variable', DataType.STR),
        Column('value', DataType.STR),
    ],
    description="Windows environment variables from memory dump",
