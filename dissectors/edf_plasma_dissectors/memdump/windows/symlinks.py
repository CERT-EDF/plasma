"""Windows Symlinks Memory Dissector"""
...
_VOL_PLUGIN = 'windows.symlinkscan.SymlinkScan'
_VOL_FIELDS_MAPPING = {
...
DISSECTOR = Dissector(
    slug='memdump_windows_symlinks',
    tags={Tag.MEMDUMP, Tag.WINDOWS},
    columns=[
        Column('create_time', DataType.STR),
        Column('offset', DataType.INT),
        Column('from_name', DataType.STR),
        Column('to_name', DataType.STR),
    ],
    description="Windows symlinks (carved) from memory dump",
